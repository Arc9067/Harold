    ...
    <section className="py-32 w-full">
      <div className="container grid grid-cols-1 lg:grid-cols-2 justify-between items-center gap-y-16">
        <article className="flex flex-col gap-5">
          <h1 className=" text-black text-6xl leading-[73px] lg:text-7xl font-goodGame lg:leading-[86.40px] tracking-wider">
            Let’s Meet Harold!
          </h1>
          <p className="max-w-[522px] text-black text-base font-normal leading-loose tracking-tight">
            In the bustling realm of cryptocurrencies, where innovation and
            absurdity often collide, HAROLD emerges as a memecoin with a
            mission. Tired of the endless parade of Inu-inspired tokens, HAROLD
            aims to reclaim the throne as the undisputed king of memes,
            leveraging the power of the Ethereum blockchain to spread its
            message of humor and camaraderie.
          </p>
              ...
              >
                ...
                <defs>
                  <clipPath id="clip0_2176_707">
                    <rect width="32" height="32" fill="blatext-black" />
                  </clipPath>
                </defs>
              </svg>
            </a>
        ...
        <img
          src={logo}
          alt=""
          className="lg:ml-auto lg:rounded-full lg:h-[30rem] lg:w-[30rem] object-cover object-top"
        />
      </div>
    </section>
  );
